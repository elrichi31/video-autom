...
import {
  TIENDAS_EN_LINEA_NECESSIDAD_NEGOCIOS_ACCENTS as ACCENTS,
  TIENDAS_EN_LINEA_NECESSIDAD_NEGOCIOS_CLOSE as CLOSE,
  TIENDAS_EN_LINEA_NECESSIDAD_NEGOCIOS_DURATIONS as D,
  TIENDAS_EN_LINEA_NECESSIDAD_NEGOCIOS_HOOK_STYLE as HOOK_STYLE,
  TIENDAS_EN_LINEA_NECESSIDAD_NEGOCIOS_INTRO as INTRO,
  TIENDAS_EN_LINEA_NECESSIDAD_NEGOCIOS_LAYERS as LAYERS,
  TIENDAS_EN_LINEA_NECESSIDAD_NEGOCIOS_NICHE as NICHE,
  TIENDAS_EN_LINEA_NECESSIDAD_NEGOCIOS_PHASE1 as PHASE1,
  TIENDAS_EN_LINEA_NECESSIDAD_NEGOCIOS_PHASE2 as PHASE2,
  TIENDAS_EN_LINEA_NECESSIDAD_NEGOCIOS_PHASE3 as PHASE3,
  TIENDAS_EN_LINEA_NECESSIDAD_NEGOCIOS_REALITY as REALITY,
  TIENDAS_EN_LINEA_NECESSIDAD_NEGOCIOS_TOTAL_DURATION as TOTAL,
} from "./tiendas-en-linea-necessidad-negocios/data";
...
export const tiendasEnLineaNecessidadNegociosDuration = TOTAL + 7 * SIL;
...
const IntroScene: FC<{ d: number }> = ({ d }) => (
  <DarkShell accent={ACCENTS.intro} durationInFrames={d} variant="alert" bgSrc={staticFile("tiendas-en-linea-necessidad-negocios/tiendas-en-linea-necessidad-negocios-intro.png")} niche={NICHE} hookStyle={HOOK_STYLE} sceneKey="intro">
    <AlertLayout
...
const LayersScene: FC<{ d: number }> = ({ d }) => (
  <DarkShell accent={ACCENTS.layers} durationInFrames={d} variant="terminal" bgSrc={staticFile("tiendas-en-linea-necessidad-negocios/tiendas-en-linea-necessidad-negocios-layers.png")} niche={NICHE} hookStyle={HOOK_STYLE} sceneKey="layers">
    <ExplainLayout
...
const PhaseScene: FC<{ pk: PhaseKey; d: number }> = ({ pk, d }) => {
  ...
  const dur    = d;
  const imgSrc = pk === "phase1" ? "tiendas-en-linea-necessidad-negocios/tiendas-en-linea-necessidad-negocios-phase1.png" : pk === "phase2" ? "tiendas-en-linea-necessidad-negocios/tiendas-en-linea-necessidad-negocios-phase2.png" : "tiendas-en-linea-necessidad-negocios/tiendas-en-linea-necessidad-negocios-phase3.png";
  return (
...
const RealityScene: FC<{ d: number }> = ({ d }) => (
  <DarkShell accent={ACCENTS.reality} durationInFrames={d} variant="body" bgSrc={staticFile("tiendas-en-linea-necessidad-negocios/tiendas-en-linea-necessidad-negocios-reality.png")} niche={NICHE} hookStyle={HOOK_STYLE} sceneKey="reality">
    <DefenseLayout
...
const CloseScene: FC<{ d: number }> = ({ d }) => (
  <DarkShell accent={ACCENTS.close} durationInFrames={d} variant="close" bgSrc={staticFile("tiendas-en-linea-necessidad-negocios/tiendas-en-linea-necessidad-negocios-close.png")} niche={NICHE} hookStyle={HOOK_STYLE} sceneKey="close">
    <CloseLayout
...
/* ─── main ─── */
export const TiendasEnLineaNecessidadNegociosComposition: FC<Props> = ({ voiceoverFile = null, voiceoverFiles = null, sceneDurations = null }) => {

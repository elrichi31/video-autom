...
import {
  ...
  RANSOMWARE_TERROR_TECNOLOGICO_HOOK_STYLE as HOOK_STYLE,
  RANSOMWARE_TERROR_TECNOLOGICO_INTRO as INTRO,
  RANSOMWARE_TERROR_TECNOLOGICO_LAYERS as LAYERS,
  RANSOMWARE_TERROR_TECNOLOGICO_NICHE as NICHE,
...
const IntroScene: FC<{ d: number }> = ({ d }) => (
  <DarkShell accent={ACCENTS.intro} durationInFrames={d} variant="alert" bgSrc={staticFile("ransomware-terror-tecnologico/ransomware-terror-tecnologico-intro.png")} niche={NICHE} hookStyle={HOOK_STYLE} sceneKey="intro">
    <AlertLayout
...
const LayersScene: FC<{ d: number }> = ({ d }) => (
  <DarkShell accent={ACCENTS.layers} durationInFrames={d} variant="terminal" bgSrc={staticFile("ransomware-terror-tecnologico/ransomware-terror-tecnologico-layers.png")} niche={NICHE} hookStyle={HOOK_STYLE} sceneKey="layers">
    <ExplainLayout
...
const PhaseScene: FC<{ pk: PhaseKey; d: number }> = ({ pk, d }) => {
  ...
  const dur    = d;
  const imgSrc = pk === "phase1" ? "ransomware-terror-tecnologico/ransomware-terror-tecnologico-phase1.png" : pk === "phase2" ? "ransomware-terror-tecnologico/ransomware-terror-tecnologico-phase2.png" : "ransomware-terror-tecnologico/ransomware-terror-tecnologico-phase3.png";
  return (
...
const RealityScene: FC<{ d: number }> = ({ d }) => (
  <DarkShell accent={ACCENTS.reality} durationInFrames={d} variant="body" bgSrc={staticFile("ransomware-terror-tecnologico/ransomware-terror-tecnologico-reality.png")} niche={NICHE} hookStyle={HOOK_STYLE} sceneKey="reality">
    <DefenseLayout
...
const CloseScene: FC<{ d: number }> = ({ d }) => (
  <DarkShell accent={ACCENTS.close} durationInFrames={d} variant="close" bgSrc={staticFile("ransomware-terror-tecnologico/ransomware-terror-tecnologico-close.png")} niche={NICHE} hookStyle={HOOK_STYLE} sceneKey="close">
    <CloseLayout

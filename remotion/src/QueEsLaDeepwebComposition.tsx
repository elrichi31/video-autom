...
/* ─── intro ─── */
const IntroScene: FC = () => (
  <DarkShell accent={ACCENTS.intro} durationInFrames={D.intro} variant="alert" bgSrc={staticFile("que-es-la-deepweb/que-es-la-deepweb-intro.png")}>
    <AlertLayout
...
const LayersScene: FC = () => (
  <DarkShell accent={ACCENTS.layers} durationInFrames={D.layers} variant="terminal" bgSrc={staticFile("que-es-la-deepweb/que-es-la-deepweb-layers.png")}>
    <ExplainLayout
...
const RealityScene: FC = () => (
  <DarkShell accent={ACCENTS.reality} durationInFrames={D.reality} variant="body" bgSrc={staticFile("que-es-la-deepweb/que-es-la-deepweb-reality.png")}>
    <DefenseLayout
...
/* ─── close ─── */
const CloseScene: FC = () => (
  <DarkShell accent={ACCENTS.close} durationInFrames={D.close} variant="close" bgSrc={staticFile("que-es-la-deepweb/que-es-la-deepweb-close.png")}>
    <CloseLayout

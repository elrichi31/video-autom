...
import {
  JUICE_JACKING_PELIGRO_CARGAR_CELULAR_ACCENTS as ACCENTS,
  JUICE_JACKING_PELIGRO_CARGAR_CELULAR_CLOSE as CLOSE,
  JUICE_JACKING_PELIGRO_CARGAR_CELULAR_DURATIONS as D,
  JUICE_JACKING_PELIGRO_CARGAR_CELULAR_HOOK_STYLE as HOOK_STYLE,
  JUICE_JACKING_PELIGRO_CARGAR_CELULAR_INTRO as INTRO,
  JUICE_JACKING_PELIGRO_CARGAR_CELULAR_LAYERS as LAYERS,
  JUICE_JACKING_PELIGRO_CARGAR_CELULAR_NICHE as NICHE,
  JUICE_JACKING_PELIGRO_CARGAR_CELULAR_PHASE1 as PHASE1,
  JUICE_JACKING_PELIGRO_CARGAR_CELULAR_PHASE2 as PHASE2,
  JUICE_JACKING_PELIGRO_CARGAR_CELULAR_PHASE3 as PHASE3,
  JUICE_JACKING_PELIGRO_CARGAR_CELULAR_REALITY as REALITY,
  JUICE_JACKING_PELIGRO_CARGAR_CELULAR_TOTAL_DURATION as TOTAL,
} from "./juice-jacking-peligro-cargar-celular/data";
...
export const juiceJackingPeligroCargarCelularDuration = TOTAL + 7 * SIL;
...
const IntroScene: FC<{ d: number }> = ({ d }) => (
  <DarkShell accent={ACCENTS.intro} durationInFrames={d} variant="alert" bgSrc={staticFile("juice-jacking-peligro-cargar-celular/juice-jacking-peligro-cargar-celular-intro.png")} niche={NICHE} hookStyle={HOOK_STYLE} sceneKey="intro">
    <AlertLayout
...
const LayersScene: FC<{ d: number }> = ({ d }) => (
  <DarkShell accent={ACCENTS.layers} durationInFrames={d} variant="terminal" bgSrc={staticFile("juice-jacking-peligro-cargar-celular/juice-jacking-peligro-cargar-celular-layers.png")} niche={NICHE} hookStyle={HOOK_STYLE} sceneKey="layers">
    <ExplainLayout
...
const PhaseScene: FC<{ pk: PhaseKey; d: number }> = ({ pk, d }) => {
  ...
  const dur    = d;
  const imgSrc = pk === "phase1" ? "juice-jacking-peligro-cargar-celular/juice-jacking-peligro-cargar-celular-phase1.png" : pk === "phase2" ? "juice-jacking-peligro-cargar-celular/juice-jacking-peligro-cargar-celular-phase2.png" : "juice-jacking-peligro-cargar-celular/juice-jacking-peligro-cargar-celular-phase3.png";
  return (
...
const RealityScene: FC<{ d: number }> = ({ d }) => (
  <DarkShell accent={ACCENTS.reality} durationInFrames={d} variant="body" bgSrc={staticFile("juice-jacking-peligro-cargar-celular/juice-jacking-peligro-cargar-celular-reality.png")} niche={NICHE} hookStyle={HOOK_STYLE} sceneKey="reality">
    <DefenseLayout
...
const CloseScene: FC<{ d: number }> = ({ d }) => (
  <DarkShell accent={ACCENTS.close} durationInFrames={d} variant="close" bgSrc={staticFile("juice-jacking-peligro-cargar-celular/juice-jacking-peligro-cargar-celular-close.png")} niche={NICHE} hookStyle={HOOK_STYLE} sceneKey="close">
    <CloseLayout
...
/* ─── main ─── */
export const JuiceJackingPeligroCargarCelularComposition: FC<Props> = ({ voiceoverFile = null, voiceoverFiles = null, sceneDurations = null }) => {

...
/* ─── intro ─── */
const IntroScene: FC = () => (
  <DarkShell accent={ACCENTS.intro} durationInFrames={D.intro} variant="alert" bgSrc={staticFile("deepfakes/deepfakes-intro.png")}>
    <AlertLayout
...
const LayersScene: FC = () => (
  <DarkShell accent={ACCENTS.layers} durationInFrames={D.layers} variant="terminal" bgSrc={staticFile("deepfakes/deepfakes-layers.png")}>
    <ExplainLayout
...
const RealityScene: FC = () => (
  <DarkShell accent={ACCENTS.reality} durationInFrames={D.reality} variant="body" bgSrc={staticFile("deepfakes/deepfakes-reality.png")}>
    <DefenseLayout
...
/* ─── close ─── */
const CloseScene: FC = () => (
  <DarkShell accent={ACCENTS.close} durationInFrames={D.close} variant="close" bgSrc={staticFile("deepfakes/deepfakes-close.png")}>
    <CloseLayout

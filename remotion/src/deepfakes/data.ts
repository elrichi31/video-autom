...
export const DEEPFAKES_DURATIONS = {
  ...
  layers:  7  * DEEPFAKES_FPS,
  phase1:  8  * DEEPFAKES_FPS,
  phase2:  7  * DEEPFAKES_FPS,
  phase3:  8  * DEEPFAKES_FPS,
  reality: 8 * DEEPFAKES_FPS,
...
export const DEEPFAKES_NICHE: VideoNiche = "general";

export const DEEPFAKES_HOOK_STYLE: HookStyle = "curiosity";

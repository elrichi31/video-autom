...
import {
  ESTAFA_IA_CLONACION_VOZ_ACCENTS as ACCENTS,
  ESTAFA_IA_CLONACION_VOZ_CLOSE as CLOSE,
  ESTAFA_IA_CLONACION_VOZ_DURATIONS as D,
  ESTAFA_IA_CLONACION_VOZ_HOOK_STYLE as HOOK_STYLE,
  ESTAFA_IA_CLONACION_VOZ_INTRO as INTRO,
  ESTAFA_IA_CLONACION_VOZ_LAYERS as LAYERS,
  ESTAFA_IA_CLONACION_VOZ_NICHE as NICHE,
  ESTAFA_IA_CLONACION_VOZ_PHASE1 as PHASE1,
  ESTAFA_IA_CLONACION_VOZ_PHASE2 as PHASE2,
  ESTAFA_IA_CLONACION_VOZ_PHASE3 as PHASE3,
  ESTAFA_IA_CLONACION_VOZ_REALITY as REALITY,
  ESTAFA_IA_CLONACION_VOZ_TOTAL_DURATION as TOTAL,
} from "./estafa-ia-clonacion-voz/data";
...
export const estafaIaClonacionVozDuration = TOTAL + 7 * SIL;
...
const IntroScene: FC<{ d: number }> = ({ d }) => (
  <DarkShell accent={ACCENTS.intro} durationInFrames={d} variant="alert" bgSrc={staticFile("estafa-ia-clonacion-voz/estafa-ia-clonacion-voz-intro.png")} niche={NICHE} hookStyle={HOOK_STYLE} sceneKey="intro">
    <AlertLayout
...
const LayersScene: FC<{ d: number }> = ({ d }) => (
  <DarkShell accent={ACCENTS.layers} durationInFrames={d} variant="terminal" bgSrc={staticFile("estafa-ia-clonacion-voz/estafa-ia-clonacion-voz-layers.png")} niche={NICHE} hookStyle={HOOK_STYLE} sceneKey="layers">
    <ExplainLayout
...
const PhaseScene: FC<{ pk: PhaseKey; d: number }> = ({ pk, d }) => {
  ...
  const dur    = d;
  const imgSrc = pk === "phase1" ? "estafa-ia-clonacion-voz/estafa-ia-clonacion-voz-phase1.png" : pk === "phase2" ? "estafa-ia-clonacion-voz/estafa-ia-clonacion-voz-phase2.png" : "estafa-ia-clonacion-voz/estafa-ia-clonacion-voz-phase3.png";
  return (
...
const RealityScene: FC<{ d: number }> = ({ d }) => (
  <DarkShell accent={ACCENTS.reality} durationInFrames={d} variant="body" bgSrc={staticFile("estafa-ia-clonacion-voz/estafa-ia-clonacion-voz-reality.png")} niche={NICHE} hookStyle={HOOK_STYLE} sceneKey="reality">
    <DefenseLayout
...
const CloseScene: FC<{ d: number }> = ({ d }) => (
  <DarkShell accent={ACCENTS.close} durationInFrames={d} variant="close" bgSrc={staticFile("estafa-ia-clonacion-voz/estafa-ia-clonacion-voz-close.png")} niche={NICHE} hookStyle={HOOK_STYLE} sceneKey="close">
    <CloseLayout
...
/* ─── main ─── */
export const EstafaIaClonacionVozComposition: FC<Props> = ({ voiceoverFile = null, voiceoverFiles = null, sceneDurations = null }) => {

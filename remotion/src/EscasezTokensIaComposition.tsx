...
import {
  ...
  ESCASEZ_TOKENS_IA_HOOK_STYLE as HOOK_STYLE,
  ESCASEZ_TOKENS_IA_INTRO as INTRO,
  ESCASEZ_TOKENS_IA_LAYERS as LAYERS,
  ESCASEZ_TOKENS_IA_NICHE as NICHE,
...
const IntroScene: FC<{ d: number }> = ({ d }) => (
  <DarkShell accent={ACCENTS.intro} durationInFrames={d} variant="alert" bgSrc={staticFile("escasez-tokens-ia/escasez-tokens-ia-intro.png")} niche={NICHE} hookStyle={HOOK_STYLE} sceneKey="intro">
    <AlertLayout
...
const LayersScene: FC<{ d: number }> = ({ d }) => (
  <DarkShell accent={ACCENTS.layers} durationInFrames={d} variant="terminal" bgSrc={staticFile("escasez-tokens-ia/escasez-tokens-ia-layers.png")} niche={NICHE} hookStyle={HOOK_STYLE} sceneKey="layers">
    <ExplainLayout
...
const RealityScene: FC<{ d: number }> = ({ d }) => (
  <DarkShell accent={ACCENTS.reality} durationInFrames={d} variant="body" bgSrc={staticFile("escasez-tokens-ia/escasez-tokens-ia-reality.png")} niche={NICHE} hookStyle={HOOK_STYLE} sceneKey="reality">
    <DefenseLayout
...
const CloseScene: FC<{ d: number }> = ({ d }) => (
  <DarkShell accent={ACCENTS.close} durationInFrames={d} variant="close" bgSrc={staticFile("escasez-tokens-ia/escasez-tokens-ia-close.png")} niche={NICHE} hookStyle={HOOK_STYLE} sceneKey="close">
    <CloseLayout
